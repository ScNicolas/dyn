...
*/
            ...
            for (int j = 0; j < 50; j++) {
                ...
                for (int i = 0; i < 10; i++) {
                    Item item = new Item().withInt("userid", j*20+i).withString("timestamp", "1000").withInt("value", j*i);
                    items.add(item);
                }
    ...
    private static Map<String, AttributeValue> newItem(String userid, double value) {
        Map<String, AttributeValue> item = new HashMap<String, AttributeValue>();
        AttributeValue valInt = new AttributeValue();
        valInt.withN(userid);
        item.put("userid", valInt);

        item.put("timestamp", new AttributeValue(String.valueOf(System.currentTimeMillis())));
        item.put("value", new AttributeValue(String.valueOf(value)));
